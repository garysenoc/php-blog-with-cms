...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            $posts_published_counts = mysqli_num_rows($select_all_published_post);
            ...
            $posts_draft_counts = mysqli_num_rows($select_all_draft_post);
            ...
            $subscribers_count = mysqli_num_rows($select_all_subscriber);
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            $element_count = [$posts_counts, $posts_published_counts, $posts_draft_counts, $comments_counts, $unapproved_comments_counts, $users_counts, $subscribers_count, $categories_counts];
