...
<form action="" method="POST" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="title" id="" value="<?php echo $post_title ?>">
    </div>
    <div class="form-group">
        ...
        <!-- 
        <input type="text" class="form-control" name="post_category_id" id="" value="<?php echo $post_category_id ?>"> -->
    </div>
    <div class="form-group">
        <label for="title">Post Author</label>
        <input type="text" class="form-control" name="author" id="" value="<?php echo $post_author ?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="post_tags" id="" value="<?php echo $post_tags ?>">
    </div>
    <div class="form-group">
